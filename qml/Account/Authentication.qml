    ...
    Flow{
        ...
        Item{
            ...
            AppButton{
                ...
                onClicked: {
                    if(!isReset)
                        userController.validateOTP(email,otpInput.text)
                    else {
                        ...
                        userController.resetPass(email, otpInput.text, passLoader.item.passInput.text)
                    }
                }
            }
        }
                ...
                AppButton{
                    ...
                    onClicked: {
                        if(waitingSecond === defaultWaintingTime){
                            otpInput.clear()
                            waiterTime.start()
                            userController.resendOTP(email)
                        }
