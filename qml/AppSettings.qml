...
Item {
    Flow{
        ...
        Flow{
            ...
            Text{
                text: qsTr("طرح زمینه") + " :"
                font{family: appStyle.shabnam;pixelSize: 35*size1F;bold:false}
            ...
            Text{
                text: qsTr("روشن")
                font{family: appStyle.shabnam;pixelSize: 35*size1F}
                verticalAlignment: Text.AlignVCenter
                color: appStyle.textColor
                height: themeSwitch.height
            }
        ...
        Item{
            ...
            App.ComboBox{
                ...
                popup.y:height
                currentIndex: usefulFunc.findInModel(translator?translator.getCurrentLanguage():"","code",langList).index
                textRole: "name"
                font{family: appStyle.shabnam;pixelSize: 35*size1F;}
                onCurrentIndexChanged: {
